...
RUN_NAME = "YourTTS-CML-TTS-CertasPalavras"
...
RESTORE_PATH = "/workspace/data/checkpoints/checkpoints_yourtts_cml_tts_dataset/best_model.pth"  # MUDAR AQUI
...
pt_config = BaseDatasetConfig(
    formatter="cml_tts",
    dataset_name="CP",
    meta_file_train="cp-metadata-claudinei_ferreira-train16-9351.csv",
    meta_file_val="",
    path=os.path.join(OUT_PATH, "datasets/CP/wavs"),
    language="pt-br",
)
...
SPEAKER_ENCODER_CHECKPOINT_PATH = (
   "/workspace/data/checkpoints/checkpoints_yourtts_cml_tts_dataset/model_se.pth"
)
SPEAKER_ENCODER_CONFIG_PATH = "/workspace/data/checkpoints/checkpoints_yourtts_cml_tts_dataset/config_se.json"

D_VECTOR_FILES = "/workspace/data/datasets/CP/wavs/speakers.json"  # List of speaker embeddings/d-vectors to be used during the training
...
#     # tmp = torch.load(embeddings_file)
#     # print(tmp.keys())
